...
void B1RunAction::BeginOfRunAction(const G4Run* /*run*/)
{
	...
	auto analysisManager = G4AnalysisManager::Instance();
	// Open an output file
	G4String fileName = "/mnt/d/ABALONE/Simulation_results/tracking/"+std::to_string(nPrimeries)+sepp+std::to_string((int)theta_source)+sepp+"track_"+std::to_string(file_count);
...
void B1RunAction::EndOfRunAction(const G4Run* /*run*/)
{
    ...
    //const B1DetectorConstruction* detector = (const B1DetectorConstruction*) G4RunManager::GetRunManager()->GetUserDetectorConstruction();
