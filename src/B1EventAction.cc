...
//B1CalorHitsCollection*B1EventAction::GetHitsCollection(G4int hcID,const G4Event* event) const {}

//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo......

void B1EventAction::PrintEventStatistics(G4double absoEdep, G4double absoTrackLength) const //G4double gapEdep, G4double gapTrackLength
{}
...
{
    PersistencyHandler* persistency = ((B1RunAction*) G4RunManager::GetRunManager()->GetUserRunAction())->getPersistencyHandler();
